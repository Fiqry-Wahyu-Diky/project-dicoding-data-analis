...
class DataAnalyzer:
    ...
    def create_sum_order_items_df(self):
        # Mengisi NaN di kolom 'product_category_name_english' dengan 'Unknown'
        self.df["product_category_name_english"].fillna("Unknown", inplace=True)
...
class BrazilMapPlotter:
    ...
    def plot(self):
        ...
        brazil = self.mpimg.imread(
            ...
            'jpg')
        # Scatter plot data geolocation pada peta Brazil
        ax = self.data.plot(kind="scatter", x="geolocation_lng", y="geolocation_lat", ax=ax, alpha=0.3, s=0.3, c='maroon')
